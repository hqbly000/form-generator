...
export default {
  ...
  methods: {
    test(){
      ...
      let formControlConf = `{"columnControlConditions":[{"baseValue":"mobile","columnAlias":"#1","columnId":15,"columnName":"mobile","compareSymbol":"","controleId":0,"dateUnit":false,"id":0}],"columnControlTargets":[{"columnId":15,"columnName":"mobile"}],"compareSymbol":"0","expression":"#1 1 2 X ( 1 + 1 )","id":0,"processDefId":"53","type":"0","targets":["mobile"],"list":[{"key":"1","group":"record","type":"column","value":"mobile"},{"key":"2","group":"text","type":"num","value":"1"},{"key":"3","group":"text","type":"text","value":"2"},{"key":"4","group":"operation","type":"X","value":"X"},{"key":"5","group":"operation","type":"(","value":"("},{"key":"6","group":"text","type":"num","value":"1"},{"key":"7","group":"operation","type":"+","value":"+"},{"key":"8","group":"text","type":"num","value":"1"},{"key":"9","group":"operation","type":")","value":")"}]}`;
